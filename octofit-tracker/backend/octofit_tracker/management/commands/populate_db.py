...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create activities
        activities = [
            Activity(user=users[0], type='Cycling', duration=30),
            Activity(user=users[1], type='Crossfit', duration=60),
            Activity(user=users[2], type='Running', duration=45),
            Activity(user=users[3], type='Strength', duration=20),
            Activity(user=users[4], type='Swimming', duration=50),
        ]
